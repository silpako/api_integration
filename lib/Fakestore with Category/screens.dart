import 'package:api_integration/Fakestore%20with%20Category/service.dart';
...
class CategoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Main Categories',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
      ),
