import 'package:api_integration/using%20dio/controller/datacontroller.dart';
import 'package:api_integration/using%20dio/utils/colors.dart';
import 'package:api_integration/using%20dio/utils/const_snackbar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(193, 25, 184, 176),
      ),
  ...
  FloatingActionButton buildFAB() {
    return FloatingActionButton(
      ...
      child: FaIcon(controller.isListDown.value
          ...
          : FontAwesomeIcons.arrowDown,color: Color.fromARGB(184, 15, 75, 84),),
    );
  }
